...
def prediction_batchsize_benchmark(
    ...
    # Light warm-up
    warm_loader = TGDataLoader(dataset, batch_size=1, shuffle=True)
...
if __name__ == "__main__":
    ...
    output_path = (
        output_dir
        / f"{args.dataset}_speed_comparison_results_{args.max_samples_per_n}_r{args.cutoff}_rh{args.cutoff_hessian}.csv"
    )
    if not redo:
