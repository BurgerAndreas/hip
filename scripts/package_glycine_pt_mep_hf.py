#!/usr/bin/env python
"""Package the 73-frame glycine proton-transfer MEP for Hugging Face upload."""
...
DATASET_NAME = "orca_wb97x_631gd_glycine_pt_mep_73"
H5_NAME = "glycine_pt_mep_73.h5"
...
def write_readme(out_dir: Path, n_samples: int) -> None:
    (out_dir / "README.md").write_text(
        f"""# ORCA wB97X-D3/6-31G(d) Glycine Proton-Transfer MEP

This folder contains {n_samples} ORCA analytical Hessian calculations along a
73-frame minimum-energy path for glycine intramolecular proton transfer.
...
- Basis: 6-31G(d)
- ORCA version: 6.1.1
- ORCA route: `! wB97X-D3 6-31G(d) TightSCF EnGrad Freq`
...
def main() -> None:
    ...
    summary = {
        ...
        "orca_version": "6.1.1",
        "path_coordinates": {
            "xi": {"description": "Reaction-path coordinate from the 73-frame MEP"},
